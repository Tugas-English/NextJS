...
const discussionPosts = [
  ...
  },
  {
    ...
    replies: [
      {
        id: '4',
        content: 'Minimal 500 kata, maksimal 1000 kata untuk surat opini ini.',
        author: {
          id: 'teacher',
          name: 'Ms. Johnson',
          avatar: '/avatars/teacher.jpg',
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-muted-foreground">{challengeData.title}</span>
          </div>
          ...
          {challengeData.status === 'completed' ? (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                {challengeData.status === 'active' && (
                  <DropdownMenuItem>Selesaikan Tantangan</DropdownMenuItem>
                )}
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              ...
              <div className="space-y-1">
                ...
                <div>
                  <Badge variant="outline">{challengeData.skill}</Badge>
                </div>
              </div>
              <div className="space-y-1">
                <div className="text-muted-foreground text-sm font-medium">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{challengeData.rewardPoints} poin</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{formatDate(challengeData.startDate)}</span>
                </div>
              </div>
              <div className="space-y-1">
                <div className="text-muted-foreground text-sm font-medium">
                ...
                <div className="flex items-center gap-1">
                  <Calendar className="text-muted-foreground h-4 w-4" />
                  <span>{formatDate(challengeData.endDate)}</span>
                </div>
              </div>
            </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span>
                  {challengeData.submissions}/{challengeData.participants}
                </span>
              </div>
            ...
            {challengeData.status === 'completed' && (
              <div className="pt-4">
                <h3 className="mb-3 text-sm font-medium">Pemenang</h3>
                <div className="space-y-4">
                  {completedChallenge.winners.map((winner, index) => (
                    <div key={winner.id} className="flex items-center gap-3">
                      ...
                      <Badge variant="secondary">{winner.score}</Badge>
                    </div>
                  ))}
                </div>
              </div>
                    ...
                    <TableRow key={participant.id}>
                      ...
                      <TableCell>
                        {participant.submittedAt ? (
                          <Badge>Sudah Mengumpulkan</Badge>
                        ) : (
                ...
                {discussionPosts.map((post) => (
                  <div key={post.id} className="rounded-md border p-4">
                    ...
                    {post.replies && post.replies.length > 0 && (
                      <div className="mt-4 space-y-4 border-l pl-8">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end">
                <Button variant="outline">Kirim ke Semua Partisipan</Button>
              </div>
            </div>
          </CardContent>
        </Card>
