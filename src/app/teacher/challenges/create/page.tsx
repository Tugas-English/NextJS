            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-3 gap-4">
                <div
                  className={cn(
                    ...
                    challengeType === 'new' && 'border-primary bg-primary/5',
                  )}
                  onClick={() => setChallengeType('new')}
                >
                  <h3 className="font-medium">Tantangan Baru</h3>
                ...
                >
                  <h3 className="font-medium">Dari Aktivitas</h3>
                  <p className="text-muted-foreground mt-1 text-sm">
                ...
                <div
                  ...
                  onClick={() => setChallengeType('assignment')}
                >
              ...
              {challengeType === 'activity' && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Pilih Aktivitas</FormLabel>
                      <Select
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Poin yang akan diberikan kepada pemenang
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Jumlah Maksimum Partisipan</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          min={1}
                      ...
                      <FormDescription>
                        Batas jumlah siswa yang dapat berpartisipasi
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Badge Tantangan (Opsional)</FormLabel>
                    <FormControl>
                      <Input
                        type="file"
                        accept="image/*"
                        onChange={(e) => {
                          ...
                          if (e.target.files && e.target.files[0]) {
                            ...
                            field.onChange('uploaded-badge-url.jpg');
                          }
                        }}
                      />
                    </FormControl>
                    <FormDescription>
                      Unggah gambar badge untuk pemenang tantangan
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
