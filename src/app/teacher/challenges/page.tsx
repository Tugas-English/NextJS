      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">+2 bulan ini</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">+15 bulan ini</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">+350 bulan ini</p>
          </CardContent>
        </Card>
      </div>
          ...
          {activeChallenge ? (
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge variant="outline">{activeChallenge.skill}</Badge>
                <Badge variant="secondary">{activeChallenge.hotsType}</Badge>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Partisipan</span>
                    <span>
              ...
              <div className="mt-4 flex justify-end gap-2">
                <Button variant="outline">Lihat Partisipan</Button>
            ...
            <div className="py-8 text-center">
              ...
              <p className="text-muted-foreground mt-2 text-sm">
                Saat ini tidak ada tantangan yang sedang berlangsung.
              </p>
              <Button className="mt-4">Buat Tantangan Baru</Button>
            </div>
          )}
        </CardContent>
      </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Tantangan yang akan dimulai dalam waktu dekat
                  </CardDescription>
                </div>
                ...
                <TableBody>
                  {upcomingChallenges.map((challenge) => (
                    <TableRow key={challenge.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline">{challenge.skill}</Badge>
                      </TableCell>
                      <TableCell>
                        <Badge variant="secondary">{challenge.hotsType}</Badge>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="flex flex-col">
                          <span className="text-xs font-medium">
                            {challenge.winners[0].name}
                          </span>
                          <span className="text-muted-foreground text-xs">
                            {challenge.winners[0].score} poin
                          </span>
                        </div>
                      </TableCell>
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem>Lihat Detail</DropdownMenuItem>
                            <DropdownMenuItem>Lihat Pemenang</DropdownMenuItem>
                            <DropdownMenuItem>
                              Lihat Pengumpulan
                            </DropdownMenuItem>
                            <DropdownMenuItem>
            ...
            <TableBody>
              {topParticipants.map((student, index) => (
                <TableRow key={student.id}>
                  <TableCell>
                    <div className="bg-primary/10 text-primary flex h-6 w-6 items-center justify-center rounded-full font-medium">
                      {index + 1}
                    </div>
                  </TableCell>
