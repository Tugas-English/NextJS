      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">+8 bulan ini</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">5 perlu dinilai</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <Card className="md:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Berdasarkan jenis skill</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="count" fill="#8884d8" name="Jumlah Aktivitas" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <Card className="md:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Jadwal dan tenggat waktu</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <Card className="md:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Berdasarkan performa HOTS</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <Avatar className="h-10 w-10">
                  <AvatarImage src="/avatars/student-3.jpg" alt="Citra Dewi" />
                  <AvatarFallback>CD</AvatarFallback>
                </Avatar>
                <div className="flex-1">
                  <div className="font-medium">Citra Dewi</div>
                  <div className="text-muted-foreground text-xs">
                    Nilai rata-rata: 90
                  </div>
                </div>
