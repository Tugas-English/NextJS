            ...
            <CardContent className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Berikan konteks dan tujuan dari diskusi ini
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Pilih kategori yang sesuai dengan jenis diskusi
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              {watchCategory === 'challenge' && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Pilih Tantangan</FormLabel>
                      <Select
                        onValueChange={field.onChange}
                        value={field.value}
                      >
            ...
            <CardContent className="space-y-6">
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <FormLabel className="text-base">Pin Diskusi</FormLabel>
                      <FormDescription>
                        Diskusi akan selalu muncul di bagian atas daftar
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <FormLabel className="text-base">Kunci Diskusi</FormLabel>
                      <FormDescription>
                        Siswa tidak akan dapat menambahkan postingan baru
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
