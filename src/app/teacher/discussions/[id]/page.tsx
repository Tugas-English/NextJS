  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-bold">{discussionThread.title}</h1>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span>{discussionThread.postsCount} postingan</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="text-muted-foreground h-4 w-4" />
                <span>{discussionThread.participantsCount} partisipan</span>
              </div>
            </div>
          </div>
        </CardHeader>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-muted-foreground text-xs">
                            {post.timestamp}
                            {post.isEdited && (
                              <span className="ml-2">(diedit)</span>
                            )}
                          </div>
                        </div>
                      </div>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem>Pin Postingan</DropdownMenuItem>
                ...
                {replyingTo === post.id && (
                  <Card className="ml-8 border-l-4">
                    ...
                    <CardFooter className="flex justify-end gap-2">
                      ...
                      <Button onClick={submitReply}>Kirim Balasan</Button>
                    </CardFooter>
                  </Card>
                )}
                ...
                {post.replies && post.replies.length > 0 && (
                  <div className="ml-8 space-y-4">
                    {post.replies.map((reply) => (
                      <Card key={reply.id} className="border-l-4">
                        <CardHeader className="pb-2">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              <Avatar className="h-8 w-8">
            ...
            {!discussionThread.isLocked && replyingTo === null && (
              <Card>
                ...
                <CardFooter className="flex justify-end">
                  <Button onClick={submitReply}>Kirim Komentar</Button>
                </CardFooter>
              </Card>
            )}
            ...
            {discussionThread.isLocked && (
              <Card className="border-destructive">
                <CardContent className="flex items-center gap-2 py-4">
                  ...
                  <p className="text-sm">
                    Diskusi ini telah dikunci. Tidak dapat menambahkan komentar
                    baru.
                  </p>
                </CardContent>
              </Card>
        ...
        <TabsContent value="participants" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {participants.length} partisipan dalam diskusi ini
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-muted-foreground text-xs">
                          {participant.postsCount} postingan
                        </div>
                      </div>
                    </div>
                    <Button variant="ghost" size="sm">
