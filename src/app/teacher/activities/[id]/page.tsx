        ...
        <div className="space-y-6 md:col-span-2">
          ...
          {activity.scaffoldingSteps &&
            activity.scaffoldingSteps.length > 0 && (
              <Card>
                <CardHeader>
                  <CardTitle>Langkah-langkah Scaffolding</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  activity.attachmentUrls.length > 0 && (
                    <div>
                      <div className="mb-2 flex items-center gap-2">
                        ...
                        <h3 className="font-medium">Lampiran</h3>
                      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Badge
                  variant={activity.isPublished ? 'default' : 'outline'}
                  className="mt-1"
                >
                  {activity.isPublished ? 'Dipublikasikan' : 'Draft'}
                </Badge>
              </div>
              ...
              <div>
                ...
                <p className="mt-1">{activity.estimatedDuration} menit</p>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="outline" className="w-full" asChild>
                <Link href={`/teacher/modules?activityId=${activity.id}`}>
