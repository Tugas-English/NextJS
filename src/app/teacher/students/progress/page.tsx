    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="individual">Kemajuan Individual</TabsTrigger>
          <TabsTrigger value="hots-analysis">Analisis HOTS</TabsTrigger>
        </TabsList>
          ...
          <div className="flex items-center gap-2">
            <Select defaultValue="all">
              ...
              <SelectContent>
                ...
                <SelectItem value="10a">Bahasa Inggris 10A</SelectItem>
                <SelectItem value="hots">HOTS Lanjutan</SelectItem>
                <SelectItem value="writing">Menulis Kreatif</SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-xs">Semester ini</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-2">
                ...
                {students.slice(0, 3).map((student, index) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="bg-primary text-primary-foreground absolute -top-2 -right-2 flex h-8 w-8 items-center justify-center rounded-full font-bold">
                        {index + 1}
                      </div>
                    </div>
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Nilai rata-rata: {student.averageScore}
                      </p>
                    </div>
        ...
        <TabsContent value="individual" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Lihat kemajuan per siswa</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                  ...
                  {students.map((student) => {
                    ...
                    return (
                      <TableRow key={student.id}>
                        ...
                        <TableCell>{student.skills.reading}</TableCell>
                        <TableCell>{student.skills.listening}</TableCell>
                        <TableCell>{student.skills.writing}</TableCell>
                        <TableCell>{student.skills.speaking}</TableCell>
                        <TableCell>
                          <Badge
                            className={
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1">
                            ...
                            <span>{student.completedActivities}</span>
                          </div>
                        </TableCell>
                        <TableCell>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadarChart outerRadius={90} data={hotsDistributionData}>
                      <PolarGrid />
            ...
            <Card>
              <CardHeader>
                <CardTitle>Area yang Perlu Ditingkatkan</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    Siswa masih kesulitan dalam menarik kesimpulan dari
                    informasi implisit. Diperlukan lebih banyak latihan untuk
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    Siswa perlu meningkatkan kemampuan mengevaluasi argumen dan
                    bukti secara kritis. Disarankan memberikan lebih banyak
                    aktivitas evaluasi.
                  </p>
                  <div className="mt-3">
                    <Link href="#">
                  ...
                  {students.map((student) => {
                    const hotsAvg =
                      (student.hotsSkills.analyze +
                        ...
                        student.hotsSkills.problemSolve +
                    ...
                    return (
                      <TableRow key={student.id}>
                        ...
                        <TableCell>{student.hotsSkills.analyze}</TableCell>
                        <TableCell>{student.hotsSkills.evaluate}</TableCell>
                        <TableCell>{student.hotsSkills.create}</TableCell>
                        <TableCell>{student.hotsSkills.problemSolve}</TableCell>
                        <TableCell>{student.hotsSkills.infer}</TableCell>
                        <TableCell>
                          <Badge
                            className={
                              hotsAvg >= 85
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Berdasarkan analisis kemajuan siswa</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="rounded-lg border p-4">
              <div className="mb-3 flex items-center gap-2">
                ...
                <h3 className="font-medium">Inferensi dari Teks Sastra</h3>
              </div>
              <p className="text-muted-foreground text-sm">
                Aktivitas membaca dan menarik kesimpulan dari teks sastra untuk
            ...
            <div className="rounded-lg border p-4">
              <div className="mb-3 flex items-center gap-2">
                <Sparkles className="text-primary h-5 w-5" />
                <h3 className="font-medium">Evaluasi Argumen</h3>
              </div>
              <p className="text-muted-foreground text-sm">
                Aktivitas menganalisis dan mengevaluasi argumen dalam artikel
                opini untuk meningkatkan kemampuan evaluasi.
              </p>
              <div className="mt-3 flex items-center gap-2">
                <Badge variant="outline">Reading</Badge>
            ...
            <div className="rounded-lg border p-4">
              <div className="mb-3 flex items-center gap-2">
                <Sparkles className="text-primary h-5 w-5" />
                <h3 className="font-medium">Pemecahan Masalah Kolaboratif</h3>
              </div>
              <p className="text-muted-foreground text-sm">
                Aktivitas pemecahan masalah dalam kelompok untuk meningkatkan
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Buat Laporan Kemajuan</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-sm">
              Buat laporan kemajuan individual untuk siswa yang membutuhkan
              perhatian khusus.
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground text-sm">
              Buat modul remedial untuk siswa yang membutuhkan bantuan dalam
              area tertentu.
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground text-sm">
              Buat tantangan mingguan yang berfokus pada area yang perlu
              ditingkatkan.
            </p>
          </CardContent>
          <CardFooter>
