    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Rata-rata 82.0</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Rata-rata 65.0</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <RadarChart outerRadius={90} data={classAverages}>
                  <PolarGrid />
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="analyze" name="Analyze" fill="#8884d8" />
                <Bar dataKey="evaluate" name="Evaluate" fill="#82ca9d" />
                <Bar dataKey="create" name="Create" fill="#ffc658" />
                <Bar
                  dataKey="problemSolve"
                  name="Problem Solve"
                  fill="#ff8042"
                />
                <Bar dataKey="infer" name="Infer" fill="#8dd1e1" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Analisis korelasi kemampuan HOTS</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip
                  ...
                  formatter={(value, name) => {
                    if (name === 'z') return [`${value}`, 'Nilai Rata-rata'];
                    return [value, name];
                  }}
            ...
            <TableBody>
              {filteredStudents.map((student) => (
                <TableRow key={student.id}>
                  ...
                  <TableCell>{student.problemSolve}</TableCell>
                  <TableCell>{student.infer}</TableCell>
                  <TableCell>
                    <Badge
                      variant={student.average >= 80 ? 'default' : 'outline'}
                    >
                      {student.average}
                    </Badge>
                  </TableCell>
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <div className="text-muted-foreground text-sm">Awal</div>
                    <div className="font-medium">{student.initialScore}</div>
                  </div>
                  <div className="text-right">
                    <div className="text-muted-foreground text-sm">
                      Sekarang
                    </div>
                    <div className="font-medium">{student.currentScore}</div>
                  </div>
                  <Badge className="ml-4">+{student.improvementRate}%</Badge>
                </div>
              </div>
            ))}
          </div>
