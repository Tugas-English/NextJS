...
const faqItems = [
  {
    ...
    answer:
      "Untuk membuat aktivitas HOTS baru, klik menu 'Aktivitas HOTS' di sidebar, lalu klik tombol 'Buat Aktivitas'. Isi form dengan informasi aktivitas yang diperlukan seperti judul, deskripsi, jenis skill, dan tipe HOTS. Anda juga dapat menambahkan konten utama, instruksi, dan file pendukung. Setelah selesai, klik tombol 'Buat Aktivitas' untuk menyimpan.",
    category: 'aktivitas',
  },
  {
  ...
  },
  {
    ...
    answer:
      "Untuk membuat tantangan mingguan, klik menu 'Tantangan Mingguan' di sidebar, lalu klik tombol 'Buat Tantangan'. Anda dapat membuat tantangan baru dari awal atau berdasarkan aktivitas/tugas yang sudah ada. Isi form dengan informasi tantangan seperti judul, deskripsi, periode, dan poin hadiah. Setelah selesai, klik tombol 'Buat Tantangan' untuk menyimpan.",
    category: 'tantangan',
  },
  {
    question: 'Bagaimana cara mengekspor laporan nilai siswa?',
    answer:
      "Untuk mengekspor laporan nilai siswa, klik menu 'Laporan & Ekspor' di sidebar. Pilih jenis laporan yang ingin diekspor (misalnya 'Kemajuan Siswa'), terapkan filter yang diinginkan, pilih format ekspor (PDF, Excel, atau CSV), lalu klik tombol 'Ekspor'. File laporan akan diunduh ke perangkat Anda.",
    category: 'laporan',
  },
  {
    question: 'Bagaimana cara mengedit rubrik penilaian?',
    answer:
      "Untuk mengedit rubrik penilaian, klik menu 'Rubrik Penilaian' di sidebar, lalu cari rubrik yang ingin diedit. Klik tombol 'Edit' pada rubrik tersebut. Anda dapat mengubah nama rubrik, deskripsi, kriteria penilaian, bobot, dan level penilaian. Setelah selesai, klik tombol 'Simpan Rubrik' untuk menyimpan perubahan.",
    category: 'rubrik',
  },
  {
    question: 'Bagaimana cara membuat modul pembelajaran?',
    answer:
      "Untuk membuat modul pembelajaran, klik menu 'Modul Pembelajaran' di sidebar, lalu klik tombol 'Buat Modul'. Isi form dengan informasi modul seperti judul, deskripsi, skill, dan tingkat kesulitan. Tambahkan aktivitas ke dalam modul dengan mengklik tombol 'Tambah' pada aktivitas yang tersedia. Atur urutan aktivitas dan tentukan apakah aktivitas tersebut wajib atau opsional. Setelah selesai, klik tombol 'Simpan Modul' untuk menyimpan.",
    category: 'modul',
  },
  {
    question: 'Bagaimana cara melihat kemajuan siswa?',
    answer:
      "Untuk melihat kemajuan siswa, klik menu 'Siswa' di sidebar, lalu pilih siswa yang ingin dilihat kemajuannya. Pada halaman detail siswa, Anda dapat melihat informasi tentang nilai rata-rata, aktivitas yang telah diselesaikan, dan analisis HOTS. Anda juga dapat melihat tugas yang telah dikerjakan, badge yang diperoleh, dan partisipasi dalam diskusi.",
    category: 'siswa',
  },
  {
    question: 'Bagaimana cara membuat forum diskusi baru?',
    answer:
      "Untuk membuat forum diskusi baru, klik menu 'Forum Diskusi' di sidebar, lalu klik tombol 'Buat Diskusi Baru'. Isi form dengan informasi diskusi seperti judul, deskripsi, dan kategori. Jika diskusi terkait dengan tugas, modul, atau tantangan tertentu, pilih item yang sesuai. Anda juga dapat mengatur opsi tambahan seperti pin diskusi atau kunci diskusi. Setelah selesai, klik tombol 'Buat Diskusi' untuk menyimpan.",
    category: 'diskusi',
  },
];
        ...
        <TabsContent value="faq" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Jawaban untuk pertanyaan umum tentang platform HOTS English
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="documentation" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Panduan lengkap dan referensi untuk platform HOTS English
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {filteredDocs.length > 0 ? (
                  filteredDocs.map((doc) => {
                    ...
                    return (
                      <div key={doc.id} className="flex rounded-md border p-4">
                        <div className="bg-primary/10 mr-4 rounded-md p-2">
                          <DocIcon className="text-primary h-6 w-6" />
                        </div>
                  ...
                  <div className="text-muted-foreground col-span-2 py-8 text-center">
                    Tidak ada dokumentasi yang ditemukan untuk &quot;
                    {searchQuery}&quot;
                  </div>
                )}
              </div>
      ...
      <Card>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="flex rounded-md border p-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  Kirim pertanyaan atau masalah Anda ke alamat email kami
                </p>
                <p className="mt-2 font-medium">support@hotsenglish.com</p>
              </div>
            </div>
            ...
            <div className="flex rounded-md border p-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  Diskusikan masalah Anda secara langsung dengan tim dukungan
                  kami
                </p>
        ...
        <CardFooter className="flex justify-center border-t pt-6">
          <div className="text-muted-foreground flex items-center gap-2 text-sm">
            ...
            <span>Dukungan tersedia Senin - Jumat, 08:00 - 17:00 WIB</span>
          </div>
        </CardFooter>
      </Card>
    </div>
