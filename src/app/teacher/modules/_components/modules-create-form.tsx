        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Skill (Opsional)</FormLabel>
                      <Select
                      ...
                      <FormDescription>
                        Opsional untuk memfilter aktivitas
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Tipe HOTS (Opsional)</FormLabel>
                      <Select
                        onValueChange={field.onChange}
                        value={field.value}
                      >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Masukkan URL gambar sampul untuk modul ini
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Tambahkan dan atur urutan aktivitas dalam modul ini
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="rounded-md border p-4">
                ...
                {selectedActivities.length === 0 ? (
                  <p className="text-muted-foreground text-sm">
                    Belum ada aktivitas yang dipilih. Tambahkan aktivitas dari
                    daftar di bawah.
                  </p>
                ) : (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Atur status publikasi modul</CardDescription>
            </CardHeader>
            <CardContent>
              <FormField
                control={form.control}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Modul akan langsung tersedia untuk siswa
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
