...
const availableActivities = [
    ...
    {
        id: "6",
        title: "Analisis Video Dokumenter",
        skill: "listening",
        hotsType: "analyze",
    },
];
...
export default function CreateModulePage() {
    ...
    async function onSubmit(data: ModuleFormValues) {
        // Menambahkan aktivitas yang dipilih ke data form
        data.activities = selectedActivities;

        try {
            console.log("Form data:", data);
            // Implementasi API call untuk menyimpan modul
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Unggah gambar sampul untuk modul ini
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
