                ...
                >
                  <div className="flex items-center gap-4">
                    <Avatar className="h-20 w-20">
                      <AvatarImage
                        src={profileForm.getValues('avatarUrl')}
                        alt="Ms. Johnson"
                      />
                              ...
                              <Input
                                ...
                                onChange={(e) => {
                                  ...
                                  if (e.target.files && e.target.files[0]) {
                                    ...
                                    field.onChange('/avatars/teacher.jpg');
                                  }
                                }}
                              />
                            </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Informasi singkat tentang diri Anda
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Terima pengingat tentang tenggat tugas
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Terima notifikasi saat siswa mengumpulkan tugas
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Terima notifikasi tentang aktivitas di forum diskusi
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Terima notifikasi tentang tantangan mingguan
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
