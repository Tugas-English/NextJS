    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="student-progress">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="student-progress">Kemajuan Siswa</TabsTrigger>
          <TabsTrigger value="assignment-results">Hasil Tugas</TabsTrigger>
            ...
            <Popover>
              ...
              <PopoverContent className="w-80">
                <div className="space-y-4">
                  <h4 className="font-medium">Rentang Waktu</h4>
                  ...
                  {studentProgressData.map((student) => {
                    ...
                    return (
                      <TableRow key={student.id}>
                        ...
                        <TableCell>{student.reading}</TableCell>
                        <TableCell>{student.listening}</TableCell>
                        <TableCell>{student.writing}</TableCell>
                        <TableCell>{student.speaking}</TableCell>
                        <TableCell>
                          <Badge
                            variant={average >= 80 ? 'default' : 'outline'}
                          >
                            {average}
                          </Badge>
                        </TableCell>
              ...
              <Table>
                ...
                <TableBody>
                  {assignmentResultsData.map((assignment) => {
                    const total = assignment.completed + assignment.pending;
                    ...
                    return (
                      <TableRow key={assignment.id}>
                        ...
                        <TableCell>
                          {assignment.completed} ({completionRate}%)
                        </TableCell>
                        <TableCell>{assignment.pending}</TableCell>
                        <TableCell>
                          <Badge
                            variant={
                              assignment.avgScore >= 80 ? 'default' : 'outline'
                            }
                          >
                            {assignment.avgScore}
                          </Badge>
        ...
        <TabsContent value="hots-analysis">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Analisis kemampuan HOTS siswa berdasarkan kategori
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
              ...
              <div className="mt-6 flex justify-center gap-4">
                <div className="text-center">
                  ...
                  <div className="text-muted-foreground text-sm">Analyze</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold">65%</div>
                  <div className="text-muted-foreground text-sm">Evaluate</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-muted-foreground text-sm">Infer</div>
                </div>
              </div>
            </CardContent>
          </Card>
